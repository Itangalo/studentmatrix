...
function onOpen() {
  ...
  {
    name : "Force student cell colors to selected cells",
    functionName : "updateCellColor"
  },
  {
    name : "Add new template sheet",
    functionName : "addTemplateSheet"
  },
  {
    name : "Create student sheets",
    functionName : "createStudentSheets"
  }]
  sheet.addMenu("Matrix stuff", entries);
};
